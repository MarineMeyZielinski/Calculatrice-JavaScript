...
// Le conteneur de toutes les touches
const keysEl = document.querySelector(".keys");

let current = "0", //Current est le chiffre/nombre affiché sur l'écran de la calculatrice
  previous = null, // propriété en lecture seule renvoie l'élément antérieur à celui spécifié dans childrenl a liste de son parent, ou null si l'élément spécifié est le premier de la liste.
  op = null, // Opérateurs
  resetNext = false; // Indiquer sur l'écran qu'au prochain clic ou numéro saisi, lcelui-ci doit se réinitialiser

// Faire apparâitre current sur l'écran de la calculatrice// Affiche la chaîne `current` dans l'élément displayEl
